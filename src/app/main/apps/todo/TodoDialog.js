            ...
            <Dialog {...todoDialog.props} onClose={this.closeTodoDialog} fullWidth maxWidth="sm">
                ...
                <DialogContent classes={{root: "p-0"}}>
                    ...
                    <label for=""><FormattedMessage id="title" values={{name: 'React.js'}}/></label>
                        ...
                        <div className="flex">
                        <label for=""><FormattedMessage id="startDate.short" values={{name: 'React.js'}}/></label>
                            <TextField
                                name="startDate"
                                label=""
                                type="datetime-local"
                                ...
                                variant="outlined"
                            />
                            <label for=""><FormattedMessage id="dueDate.short" values={{name: 'React.js'}}/></label>
                            <TextField
                                name="dueDate"
                                label=""
                                type="datetime-local"
                ...
                {todoDialog.type === 'new' ? (
                    <DialogActions className="justify-between pl-8 sm:pl-16">
                        ...
                        >
                           <FormattedMessage id="add" values={{name: 'React.js'}}/>
