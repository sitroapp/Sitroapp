                            ...
                            <div className="flex flex-col items-start max-w-full">
                                ...
                                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                                    <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/apps/e-commerce/products">
                                        ...
                                        <FormattedMessage id="products" values={{name: 'React.js'}}/>
                                    </Typography>
                                </FuseAnimate>
                                ...
                                <div className="flex items-center max-w-full">
                                    ...
                                    <div className="flex flex-col min-w-0">
                                        ...
                                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                                            <Typography variant="caption"><FormattedMessage id="product.detail" values={{name: 'React.js'}}/></Typography>
                                        </FuseAnimate>
                                    </div>
                                </div>
                            </div>
                ...
                content={
                    form && (
                        <div className="p-16 sm:p-24 max-w-2xl">
                            ...
                            (
                                <div>
<label for=""><FormattedMessage id="product.name" values={{name: 'React.js'}}/></label>
                                    <TextField
...
<label for=""><FormattedMessage id="description" values={{name: 'React.js'}}/></label>
                                    <TextField
                                        className="mt-8 mb-16"
                                        id="description"
                                        name="description"
                            ...
                            {tabValue === 2 && (
                                <div>
<label for=""><FormattedMessage id="priceTaxExcl" values={{name: 'React.js'}}/></label>
                                    <TextField
                                        className="mt-8 mb-16"
                                        label=""
                                        id="priceTaxExcl"
                                        ...
                                        fullWidth
                                    />
<label for=""><FormattedMessage id="priceTaxIncl" values={{name: 'React.js'}}/></label>
                                    <TextField
                                        className="mt-8 mb-16"
                                        label=""
                                        id="priceTaxIncl"
...
<label for=""><FormattedMessage id="taxRate" values={{name: 'React.js'}}/></label>
                                    <TextField
                                        className="mt-8 mb-16"
                                        label=""
                                        id="taxRate"
...
<label for=""><FormattedMessage id="comparedPrice" values={{name: 'React.js'}}/></label>
                                    <TextField
                                        className="mt-8 mb-16"
                                        label=""
                                        id="comparedPrice"
...
<label for=""><FormattedMessage id="sku" values={{name: 'React.js'}}/></label>
                                    <TextField
                                        className="mt-8 mb-16"
                                        required
                                        label=""
...
<label for=""><FormattedMessage id="quantity" values={{name: 'React.js'}}/></label>
                                    <TextField
                                        className="mt-8 mb-16"
                                        label=""
                                        id="quantity"
