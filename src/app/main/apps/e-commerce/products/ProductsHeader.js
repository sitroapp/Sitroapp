        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6"><FormattedMessage id="products" values={{name: 'React.js'}}/></Typography>
                </FuseAnimate>
            </div>
            ...
            <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Button component={Link} to="/apps/e-commerce/products/new" className="whitespace-no-wrap" variant="contained">
                    <span className="hidden sm:flex"><FormattedMessage id="product.addNew" values={{name: 'React.js'}}/></span>
