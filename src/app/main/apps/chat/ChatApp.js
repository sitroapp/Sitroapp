                            ...
                            {!chat ?
                                (
                                    <div className="flex flex-col flex-1 items-center justify-center p-24">
                                        ...
                                        <Typography variant="h6" className="my-24"><FormattedMessage id="chat.app" values={{name: 'React.js'}}/> </Typography>
                                        <Typography className="hidden md:flex px-16 pb-24 mt-24 text-center" color="textSecondary">
                                        <FormattedMessage id="chat.start2" values={{name: 'React.js'}}/>   
                                        </Typography>
