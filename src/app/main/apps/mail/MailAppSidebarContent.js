        ...
        <FuseAnimate animation="transition.slideUpIn" delay={400}>
            ...
            <div className="flex-auto border-l-1">
                ...
                <div>
                    ...
                    <List>
                        <ListSubheader className={classes.listSubheader} disableSticky><FormattedMessage id="folders" values={{name: 'React.js'}}/></ListSubheader>
                    ...
                    <List>
                        ...
                        <ListSubheader className={classes.listSubheader} disableSticky><FormattedMessage id="filters" values={{name: 'React.js'}}/></ListSubheader>
