...
class ContactDialog extends Component {
    ...
    render()
    {
		...
		<label for=""><FormattedMessage id="name" values={{name: 'React.js'}}/></label>
		...
		<label for=""><FormattedMessage id="lastName" values={{name: 'React.js'}}/></label>
		...
		<label for=""><FormattedMessage id="nickname" values={{name: 'React.js'}}/></label>
                        <TextField
                            className="mb-24"
                            label=""
                            id="nickname"
		...
		<label for=""><FormattedMessage id="phone.short" values={{name: 'React.js'}}/></label>
					</div>
                        <TextField
                            className="mb-24"
                            label=""
		...
		<label for=""><FormattedMessage id="email.short" values={{name: 'React.js'}}/></label>
                        <TextField
                            className="mb-24"
                            label=""
                            id="email"
		...
		<label for=""><FormattedMessage id="company" values={{name: 'React.js'}}/></label>
                        <TextField
                            className="mb-24"
                            label=""
                            id="company"
		...
		<label for=""><FormattedMessage id="jobTitle" values={{name: 'React.js'}}/></label>
                        <TextField
                            className="mb-24"
                            label=""
                            id="jobTitle"
		...
		<label for=""><FormattedMessage id="birthday" values={{name: 'React.js'}}/></label>
                        <TextField
                            className="mb-24"
                            id="birthday"
                            label=""
		...
		<label for=""><FormattedMessage id="address" values={{name: 'React.js'}}/></label>
                        <TextField
                            className="mb-24"
                            label=""
                            id="address"
