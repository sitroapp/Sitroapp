                    ...
                    <Paper elevation={1} className="rounded-8">
                        ...
                        <List>
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary="" disableTypography={true}/>
                                <FormattedMessage id="contacts.all" values={{name: 'React.js'}}/>
                            </ListItem>
                            <ListItem
                                button
                                component={NavLink}
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary="" disableTypography={true}/>
                                <FormattedMessage id="contacts.frequent" values={{name: 'React.js'}}/>
                            </ListItem>
                            <ListItem
                                button
                                component={NavLink}
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary="" disableTypography={true}/>
                                <FormattedMessage id="contacts.starred" values={{name: 'React.js'}}/>
                            </ListItem>
                        </List>
                    </Paper>
                </FuseAnimate>
