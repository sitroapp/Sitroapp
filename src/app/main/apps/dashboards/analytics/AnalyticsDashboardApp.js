                    ...
                    <div className="flex flex-col md:flex-row sm:p-8 container">
                        ...
                        <div className="flex flex-1 flex-col min-w-0">
                            ...
                            <FuseAnimate delay={600}>
                                <Typography className="p-16 pb-8 text-18 font-300">
                                  ...
                                  <h2><FormattedMessage id="active.users" values={{name: 'React.js'}}/></h2>
                            ...
                            <FuseAnimate delay={600}>
                                ...
                                <FormattedMessage id="AnalyticsDashboard.usersPages" values={{name: 'React.js'}}/>
                            ...
                            <FuseAnimate delay={600}>
                                <Typography className="px-16 pb-8 text-18 font-300">
                                <FormattedMessage id="AnalyticsDashboard.usersLocation" values={{name: 'React.js'}}/>
                                </Typography>
                            </FuseAnimate>
                        ...
                        <div className="flex flex-wrap w-full md:w-320 pt-16">
                            ...
                            <div className="mb-32 w-full sm:w-1/2 md:w-full">
                                <FuseAnimate delay={600}>
                                    <Typography className="px-16 pb-8 text-18 font-300">
                                    <FormattedMessage id="AnalyticsDashboard.topDevices" values={{name: 'React.js'}}/>
                                    </Typography>
                                </FuseAnimate>
                            ...
                            <div className="mb-32 w-full sm:w-1/2 md:w-full">
                                ...
                                <FuseAnimate delay={600}>
                                    ...
                                    <FormattedMessage id="AnalyticsDashboard.sales" values={{name: 'React.js'}}/>
                                    </div>
                                </FuseAnimate>
                            ...
                            <div className="mb-32 w-full sm:w-1/2 md:w-full">
                                <FuseAnimate delay={600}>
                                    ...
                                    <FormattedMessage id="AnalyticsDashboard.topCam" values={{name: 'React.js'}}/>
                                    </Typography>
                                </FuseAnimate>
                                <div className="widget w-full p-16">
