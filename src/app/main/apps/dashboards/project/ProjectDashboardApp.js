            ...
            <FusePageSimple
                ...
                header={
                    <div className="flex flex-col justify-between flex-1 px-24 pt-24">
                        <div className="flex justify-between items-start">
                            <Typography className="py-0 sm:py-24" variant="h4"><FormattedMessage id="welcome.back" values={{name: 'React.js'}}/></Typography>
                            <Hidden lgUp>
                                <IconButton
                ...
                contentToolbar={
                    ...
                    >
                        ...
                        <Tab className="text-14 font-600 normal-case" label="Etusivu"/>
                        <Tab className="text-14 font-600 normal-case" label="Budjetti"/>
                        <Tab className="text-14 font-600 normal-case" label="Tiimin jäsenet"/>
                    </Tabs>
                }
                content={
                    <div className="p-12">
