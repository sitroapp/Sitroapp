                ...
                <FuseAnimate animation={{translateX: [0, '100%']}}>
                    ...
                    <Card className="w-full max-w-400 mx-auto m-16 md:m-0" square>
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">
                            ...
                            <Typography variant="h6" className="md:w-full mb-32"><FormattedMessage id="login.toAccount" values={{name: 'React.js'}}/></Typography>
                            ...
                            <form name="loginForm" noValidate className="flex flex-col justify-center w-full">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <FormattedMessage id="login.forgotPassword" values={{name: 'React.js'}}/>
                                    </Link>
                                </div>
                            ...
                            <div className="flex flex-col items-center justify-center pt-32 pb-24">
                                ...
                                <Link className="font-medium" to="/pages/auth/register-2"><FormattedMessage id="create.account" values={{name: 'React.js'}}/></Link>
                            </div>
