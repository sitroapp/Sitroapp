                    ...
                    <FuseAnimate animation="transition.expandIn">
                        ...
                        <Card className="w-full max-w-384">
                            ...
                            <CardContent className="flex flex-col items-center justify-center p-32">
                                ...
                                <Typography variant="h6" className="mt-16 mb-32"><FormattedMessage id="login.toAccount" values={{name: 'React.js'}}/></Typography>
                                ...
                                <div className="flex flex-col items-center justify-center pt-32 pb-24">
                                    ...
                                    <Link className="font-medium" to="/pages/auth/register"><FormattedMessage id="create.account" values={{name: 'React.js'}}/></Link>
                                </div>
