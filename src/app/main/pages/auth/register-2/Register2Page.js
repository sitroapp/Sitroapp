                ...
                <FuseAnimate animation={{translateX: [0, '100%']}}>
                    ...
                    <Card className="w-full max-w-400 mx-auto m-16 md:m-0" square>
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">
                            ...
                            <Typography variant="h6" className="md:w-full mb-32"><FormattedMessage id="create.account2" values={{name: 'React.js'}}/></Typography>
                            ...
                            <form name="registerForm" noValidate className="flex flex-col justify-center w-full">
                                ...
                                <Button variant="contained" color="primary" className="w-full mx-auto mt-16" aria-label="Register"
                                    ...
                                    <FormattedMessage id="create.account2" values={{name: 'React.js'}}/>
                                </Button>
                            ...
                            <div className="flex flex-col items-center justify-center pt-32 pb-24">
                                ...
                                <Link className="font-medium" to="/pages/auth/login-2"><FormattedMessage id="login.login" values={{name: 'React.js'}}/></Link>
                            </div>
