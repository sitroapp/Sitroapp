...
import Flags from 'app/fuse-layouts/shared-components/FlaggLinks';
                ...
                <FuseAnimate animation={{translateX: [0, '100%']}}>
                    ...
                    <Card className="w-full max-w-400 mx-auto m-16 md:m-0" square>
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">
                            ...
                            <Typography variant="h6" className="md:w-full mb-32"><FormattedMessage id="register.account" values={{name: 'React.js'}}/></Typography>
                            ...
                            <div className="flex flex-col items-center justify-center pt-32 pb-24">
                                ...
                                <Link className="font-medium" to="/login"><FormattedMessage id="login.login" values={{name: 'React.js'}}/></Link>
                                <Link className="font-medium mt-8" to="/"><FormattedMessage id="backTo.dashboard" values={{name: 'React.js'}}/></Link>
                            </div>
